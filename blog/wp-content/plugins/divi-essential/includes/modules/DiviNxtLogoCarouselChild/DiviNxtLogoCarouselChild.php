...
class Divi_NxtLogoCarouselChild extends ET_Builder_Module
{
    ...
    public function render($attrs, $content = null, $render_slug){
        ...
        if ("" !== $logo_carousel_width) {
            $logo_carousel_width_style = sprintf('width: %1$s;', esc_attr__($logo_carousel_width, 'dnxte-divi-essential'));
            $logo_carousel_width_style_tablet = sprintf('width: %1$s;', esc_attr__($logo_carousel_width_tablet, 'dnxte-divi-essential'));
            $logo_carousel_width_style_phone = sprintf('width: %1$s;', esc_attr__($logo_carousel_width_phone, 'dnxte-divi-essential'));
            $logo_carousel_width_style_hover = "";

            if (et_builder_is_hover_enabled('logo_carousel_width', $this->props)) {
                $logo_carousel_width_style_hover = sprintf('width: %1$s;', esc_attr__($logo_carousel_width_hover, 'dnxte-divi-essential'));
            }
