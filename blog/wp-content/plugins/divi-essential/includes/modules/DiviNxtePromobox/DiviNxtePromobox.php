...
class Divi_NxtePromobox extends ET_Builder_Module
{
    ...
    public function render($attrs, $content = null, $render_slug)
    {
        ...
        if ("" !== $button_bg) {
            $button_bg_style = sprintf('background-color: %1$s;', esc_attr__($button_bg, 'dnxte-divi-essential'));
            $button_bg_style_tablet = sprintf('background-color: %1$s', esc_attr__($button_bg_tablet, 'dnxte-divi-essential'));
            $button_bg_style_phone = sprintf('background-color: %1$s', esc_attr__($button_bg_phone, 'dnxte-divi-essential'));
            $button_bg_style_hover = "";

            if (et_builder_is_hover_enabled('dnxte_promobox_button_bg_color', $this->props)) {
                $button_bg_style_hover = sprintf('background-color: %1$s;', esc_attr__($button_bg_hover, 'dnxte-divi-essential'));
            }
            ...
            if ("" !== $button_bg_style_hover) {
                ET_Builder_Element::set_style($render_slug, array(
                    'selector' => $this->add_hover_to_order_class("%%order_class%% .dnxte-promobx-btn:hover"),
        ...
        if ("" !== $offer_bg) {
            ...
            if ("" !== $offer_bg_style_hover) {
                ET_Builder_Element::set_style($render_slug, array(
                    'selector' => $this->add_hover_to_order_class("%%order_class%% .dnxte-promo-box-badge:hover"),
        ...
        // Offer width height
        $offer_width = $this->props['dnxte_promobox_offer_width'];
        ...
        $offer_height = $this->props['dnxte_promobox_offer_height'];
        ...
        if ("" !== $offer_width || "" !== $offer_height) {
            $offer_size_style = sprintf('width: %1$s;height: %2$s;', esc_attr__($offer_width, 'dnxte-divi-essential'), esc_attr__($offer_height, 'dnxte-divi-essential'));
            $offer_size_style_tablet = sprintf('width: %1$s;height: %2$s;', esc_attr__($offer_width_tablet, 'dnxte-divi-essential'), esc_attr__($offer_height_tablet, 'dnxte-divi-essential'));

            $offer_size_style_phone = sprintf('width: %1$s;height: %2$s;', esc_attr__($offer_width_phone, 'dnxte-divi-essential'), esc_attr__($offer_height_phone, 'dnxte-divi-essential'));
            ...
            if (et_builder_is_hover_enabled('dnxte_promobox_offer_width', $this->props) || et_builder_is_hover_enabled('dnxte_promobox_offer_height', $this->props)) {
                $offer_size_style_hover = sprintf('width: %1$s;height: %2$s;', esc_attr__($offer_width_hover, 'dnxte-divi-essential'), esc_attr__($offer_height_hover, 'dnxte-divi-essential'));
            }
        ...
        $button_alignment_style = sprintf('justify-content: %1$s;', esc_attr__($button_alignment, 'dnxte-divi-essential'));
