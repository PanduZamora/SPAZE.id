...
class DNEXT_FlipBox extends ET_Builder_Module {
		...
		$this->advanced_fields = array(
			...
			'borders'               => array(
				'default' => array(
					'css'          => array(
						'main'     => array(
							'border_radii'  		=> "%%order_class%% .dnext-flpb-flibbox-card-wrapper",
							'border_radii_hover'  	=> '%%order_class%%:hover .dnext-flpb-flibbox-card-wrapper',
							'border_styles' 		=> "%%order_class%% .dnext-flpb-flibbox-card-wrapper",
							'border_styles_hover' 	=> '%%order_class%%:hover .dnext-flpb-flibbox-card-wrapper',
						),
					),
					'defaults'        => array(
			...
			'box_shadow'            => array(
				'default' => array(
					'css'                 => array(
						'main'        => "%%order_class%% .dnext-flpb-flibbox-card-wrapper",
						'hover'       => '%%order_class%%:hover .dnext-flpb-flibbox-card-wrapper',
						'overlay'     => 'inset',
					),
				),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( 'off' !== $front_icon_switch ) {
			...
			$fronticon = '<span class="et-waypoint et_pb_animation_top et-animated dnext-flpb-flibbox-icon-font '.esc_attr( $front_icon_alignment_classes ).'" data-icon="'.esc_attr( et_pb_process_font_icon( $front_icon )).'"></span>';
		...
		if ( 'off' !== $back_icon_switch ) {
			...
			$backicon = '<span class="et-waypoint et_pb_animation_top et-animated dnext-flpb-flibbox-icon-back '.esc_attr( $back_icon_alignment_classes ).'" data-icon="'.esc_attr( et_pb_process_font_icon( $back_icon )).'"></span>';
		...
		if( 'off' !== $back_image_switch) {
			$backicon .= sprintf('<div class="dnext-flipbox-image dnext-flipbox-back-image %3$s" data-svg-shape="%4$s" data-shape-size="%5$s" data-use-upload="%6$s" data-uploaded-mask="%7$s"><img src="%1$s" alt="%2$s" class="dnext-flpb-flipbox-back-image"/></div>', esc_attr__($back_image, 'dnxte-divi-essential'), esc_attr__($back_image_alt, 'dnxte-divi-essential'), esc_attr__($back_image_alignment_classes, 'dnxte-divi-essential'), $back_shape_name, $back_shape_size, $back_use_mask_upload, $back_uploaded_mask);
		}
