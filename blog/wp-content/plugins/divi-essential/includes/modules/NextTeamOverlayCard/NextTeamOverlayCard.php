...
class Next_Team_Overlay_Card extends ET_Builder_Module
{
    ...
    {
        $this->name = esc_html__('Next Team Overlay Card', 'dnxte-divi-essential');
            ...
            'general' => array(
                'toggles' => array(
                    ...
                    'teamovlcard_img_ovl' => array(
                        'title' => esc_html__('Image Overlay Color', 'dnxte-divi-essential'),
                        'priority' => 80,
                    ),
                ),
            ),
            'advanced' => array(
                'toggles' => array(
                    ...
                    "teamovl_card_alignment" => array(
                        'title' => esc_html__('Social Aligment', 'dnxte-divi-essential'),
                    ),
                ),
            ),
            'custom_css' => array(
        ...
        $this->custom_css_fields = array(
            'teamovl_image_wrapper' => array(
                ...
                'selector' => '%%order_class%% .dnxte-teamovlay-img',
            ),
    ...
    public function get_fields()
    {
        $fields = array(
            ...
            'teamoverlay_card_position' => array(
                ...
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__("Input the team's position.", 'dnxte-divi-essential'),
                'toggle_slug' => 'main_content',
                'dynamic_content' => 'text',
                'mobile_options' => true,
                'hover' => 'tabs',
            ...
            'teamovlcard_alignment' => array(
                'label' => esc_html__('Social Item Alignment', 'dnxte-divi-essential'),
            ...
            'teamovlcard_hover_overlay' => array(
                'label' => esc_html__('Select Overlay Color', 'dnxte-divi-essential'),
                'type' => 'color-alpha',
            ...
            'teamovl_card_desc_margin' => array(
                'label' => esc_html__('Descrition Margin', 'dnxte-divi-essential'),
                'type' => 'custom_margin',
                'mobile_options' => true,
                'hover' => 'tabs',
