...
class Next_Button extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
        ...
        if ('right' === $this->props['btn_icon_placement']) {
            $rightItag = '<i class="et-waypoint et_pb_animation_top et-pb-icon et-animated" data-icon=' . $dataIcon . '></i>';
        } else if ('left' === $this->props['btn_icon_placement']) {
            $lefItag = '<i class="et-waypoint et_pb_animation_top et-pb-icon et-animated" data-icon=' . $dataIcon . '></i>';
        }
    ...
    public function apply_css($render_slug) {
		...
		if ( '' !== $btn_icon_color ) {
			...
			if ( "" !== $btn_icon_color_style_hover ) {
				ET_Builder_Element::set_style( $render_slug, array(
					'selector'    => $this->add_hover_to_order_class( "%%order_class%% .dnxt-btn-icon:hover i:before" ),
