...
class Next_Team_Social_Reveal_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$dnext_social_icon = $this->props['dnext_social_icon'];
		$social_icon = '<span class="" data-icon="'.esc_attr( et_pb_process_font_icon( $dnext_social_icon )).'"></span>';
		...
		$output ="<li class='dnxte-teamsorev-sn'>
				<a href='{$teamsorev_url}' class='dnext-{$dnext_social_network}' target={$teamsorev_target}>{$social_icon}</a>
			</li>";
