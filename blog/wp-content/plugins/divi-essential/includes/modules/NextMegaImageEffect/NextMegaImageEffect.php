...
class Next_Mega_Image_Effect extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if ( 'off' !== $dnxtiep_btn_show_hide ) {
			...
			$button_icon 	= 'off' !== $dnxtiep_btn_switch ? $dnxtiep_btn_icon : '';

			//Button On Hover class inner
			$btnIconOnHover = 'on' === $this->props['dnxtiep_btn_on_hover'] ? "dnxtiep-btn-icon-on-hover" : "";

			$button = '<div class="dnxtiep-button"><a href="'.esc_url( $dnxtiep_button_link).'" class="dnxt-nie-uih-btn ih-fade-up ih-delay-lg '.esc_attr($btnIconOnHover).'" data-icon="'.esc_attr( et_pb_process_font_icon( $button_icon )).'">'.et_core_esc_previously( $dnxtiep_button_text ).'</a></div>';
		}
