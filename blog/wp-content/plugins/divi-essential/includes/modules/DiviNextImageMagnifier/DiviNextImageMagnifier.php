...
class DiviNextImageMagnifier extends ET_Builder_Module {
    ...
    public function get_fields() {
        return array(
            'magnifier_upload' => array(
                ...
                'choose_text' => esc_attr__('Choose a image', 'dnxte-divi-essential'),
                'update_text' => esc_attr__('Update image', 'dnxte-divi-essential'),
                'data_type' => 'image',
            ),
            'image_alt' => array(
    ...
    public function render($attrs, $content = null, $render_slug) {
        ...
        if ("" !== $magnifier_lens_width) {
            $lens_size_style = sprintf('width: %1$s !important;height: %1$s !important', esc_attr__($magnifier_lens_width, 'dnxte-divi-essential'));
            $lens_size_style_tablet = sprintf('width: %1$s !important;height: %1$s !important;', esc_attr__($magnifier_lens_width_tablet, 'dnxte-divi-essential'));

            $lens_size_style_phone = sprintf('width: %1$s !important;height: %1$s !important;', esc_attr__($magnifier_lens_width_phone, 'dnxte-divi-essential'));
            $lens_size_style_hover = "";

            if (et_builder_is_hover_enabled('magnifier_lens_width', $this->props)) {
                $lens_size_style_hover = sprintf('width: %1$s !important;height: %1$s !important;', esc_attr__($magnifier_lens_width_hover, 'dnxte-divi-essential'));
            }
