...
class Divi_NxteFloatingElementChild extends ET_Builder_Module
{
    ...
    public function render($attrs, $content = null, $render_slug)
    {
        ...
        $dnxte_floting_shape_animation_style = sprintf('-webkit-animation: %1$s %2$s %3$s %4$s %5$s;
          animation: %1$s %2$s %3$s %4$s %5$s;', esc_attr__($dnxte_floting_shape_effect, 'dnxte-divi-essential'), esc_attr__($dnxte_floting_shape_effect_duration, 'dnxte-divi-essential'), esc_attr__($dnxte_floting_shape_effect_direction, 'dnxte-divi-essential'), $dnxte_floting_shape_effect_count, esc_attr__($dnxte_floting_shape_effect_timing, 'dnxte-divi-essential'));
        ...
        $floting_item = "";
        if ($dnxte_floting_shape_use_image === "on") {
            $floting_item = sprintf('<img class="%3$s" src="%1$s" alt="%2$s" />', esc_attr__($dnxte_floting_shape_image, 'dnxte-divi-essential'), esc_attr__($dnxte_floting_shape_image_alt, 'dnxte-divi-essential'), esc_attr__($handle_classes, 'dnxte-divi-essential'));
        } elseif ($dnxte_floting_shape_use_text === "on") {
            $floting_item = sprintf('<div class="%2$s">%1$s</div>', esc_attr__($dnxte_floting_shape_text, 'dnxte-divi-essential'), esc_attr__($handle_classes, 'dnxte-divi-essential'));
        }
