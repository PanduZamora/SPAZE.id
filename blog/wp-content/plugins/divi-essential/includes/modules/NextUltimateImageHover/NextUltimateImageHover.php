...
class Next_Ultimate_Image_Hover extends ET_Builder_Module {
		...
		return array(
			'fonts' => array(
				'hover_text_fonts' => array(
					'label'    		=> esc_html__( 'Hover Text Fonts', 'dnxte-divi-essential' ),
					'toggle_slug'   => 'dnxtiep_uih_fonts',
				...
				'hover_text_heading_bold' => array(
					'label'    		=> esc_html__( 'Heading Blod', 'dnxte-divi-essential' ),
					'toggle_slug'   => 'dnxtiep_uih_fonts',
					'sub_toggle'    => 'sub_toggle_focus',
					'tab_slug'		=> 'advanced',
					'css'      => array(
			...
			'margin_padding' => array(
				'css' => array(
					'margin' => "%%order_class%% .dnext-neip-uih-grid",
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if("effect-15" === $dnxtiep_uih_hover_effect) {
			...
			// $final_desc = explode("</p>", $final_desc);
			// $final_desc = implode("</p><br/>", $final_desc);
			
			// $final_desc = sprintf('<div class="dnext-neip-uih-descwrap">%1$s</div>', $final_desc);
		}else {
			$final_desc = sprintf('<div class="dnext-neip-uih-des-pra">%1$s</div>', $desc);
		}
