	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		if($dnxtiep_iie_hover_effect === "zoe") {
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_one']) {
				$iconlinks1 = sprintf(
					'<a href="%2$s" target="%3$s"><span class="dnxtiep_iie_icon dnxtiep_iie_icon1 et-pb-icon">%1$s</span></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_one'])),
					$linkone,
					$linktargetone
				);
			}
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_two']) {
				$iconlinks2 = sprintf(
					'<a href="%2$s" target="%3$s"><span class="dnxtiep_iie_icon dnxtiep_iie_icon2 et-pb-icon">%1$s</span></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_two'])),
					$linktwo,
					$linktargettwo
				);
			}
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_three']) {
				$iconlinks3 = sprintf(
					'<a href="%2$s" target="%3$s"><span class="dnxtiep_iie_icon dnxtiep_iie_icon3 et-pb-icon">%1$s</span></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_three'])),
					$linkthree,
					$linktargetthree
				);
			}
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_four']) {
				$iconlinks4 = sprintf(
					'<a href="%2$s" target="%3$s"><span class="dnxtiep_iie_icon dnxtiep_iie_icon4 et-pb-icon">%1$s</span></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_four'])),
					$linkfour,
					$linktargetfour
				);
			}
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_one']) {
				$iconlinks1 = sprintf(
					'<a href="%2$s" target="%3$s"><i class="dnxtiep_iie_icon dnxtiep_iie_icon1 et-pb-icon">%1$s</i></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_one'])),
					$linkone,
					$linktargetone
				);
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_two']) {
				$iconlinks2 = sprintf(
					'<a href="%2$s" target="%3$s"><i class="dnxtiep_iie_icon dnxtiep_iie_icon2 et-pb-icon">%1$s</i></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_two'])),
					$linktwo,
					$linktargettwo
				);
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_three']) {
				$iconlinks3 = sprintf(
					'<a href="%2$s" target="%3$s"><i class="dnxtiep_iie_icon dnxtiep_iie_icon3 et-pb-icon">%1$s</i></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_three'])),
					$linkthree,
					$linktargetthree
				);
			...
			if('off' !== $this->props['dnxtiep_iie_icon_show_hide_four']) {
				$iconlinks4 = sprintf(
					'<a href="%2$s" target="%3$s"><i class="dnxtiep_iie_icon dnxtiep_iie_icon4 et-pb-icon">%1$s</i></a>',
					esc_attr(et_pb_process_font_icon($this->props['dnxtiep_iie_icon_image_select_four'])),
					$linkfour,
					$linktargetfour
				);
