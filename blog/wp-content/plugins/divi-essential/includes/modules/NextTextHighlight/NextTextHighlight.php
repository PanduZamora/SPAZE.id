...
class Next_Text_Highlight extends ET_Builder_Module {
	...
	public function init() {
		$this->name 		= esc_html__( 'Next Text Highlight', 'dnxte-divi-essential' );
		$this->icon_path    = plugin_dir_path( __FILE__ ) . 'icon.svg';

		$this->settings_modal_toggles = array(
			'general'	=> array(
				'toggles'		=>	array(
					'dnxt_highlight_text'	=> esc_html__( 'Text', 'dnxte-divi-essential' ),
				),
			),
			'advanced'	=> array(
				'toggles'		=>	array(
					...
					'dnxt_text_alignment'=> array(
						'title'             => esc_html__('Text Alignment', 'dnxte-divi-essential'),
						'priority'          => 5,
					),
				),
			),
	...
	public function get_fields() {
		return array(
			...
			'highlight_alignment' => array(
                ...
                'description'     => esc_html__('Align social item to the left, right or center.', 'dnxte-divi-essential'),
                'type'            => 'align',
			...
			// Highlight Color
			'stroke_color'       => array(
				'label'          => esc_html__('Select Color', 'dnxte-divi-essential'),
				'type'           => 'color-alpha',
				'description'     => esc_html__( 'Select a suitable color to use as highlight for the text.', 'dnxte-divi-essential' ),
				'tab_slug'       => 'advanced',
			...
			'stroke_width'		=> array(
				...
				'type'			=> 'range',
				'description'     => esc_html__( 'Adjust the width of the stroke added for the highlighted text.', 'dnxte-divi-essential' ),
				'tab_slug'		=> 'advanced',
				'toggle_slug'	=> 'dnxt_highlight_stroke_toggle',
				'default'		=> '9px',
				'mobile_options'=>	true,
			...
			'dnxt_svg_select'           => array(
				'label'             => esc_html__( 'Select Highlight Style', 'dnxte-divi-essential' ),
				'type'              => 'select',
				'option_category'   => 'basic_option',
				'toggle_slug'       => 'dnxt_highlight_text',
				'default'           => 'underline',
				...
				'options'           => array(
					...
					'curly-line'    => esc_html__( 'Curly Line', 'dnxte-divi-essential' ),
					'delete'        => esc_html__( 'Delete', 'dnxte-divi-essential' ),
					'circle'        => esc_html__( 'Circle', 'dnxte-divi-essential' ),
					'diagonal'      => esc_html__( 'Diagonal', 'dnxte-divi-essential' ),
					'double'      	=> esc_html__( 'Double', 'dnxte-divi-essential' ),
					'double'      	=> esc_html__( 'Double', 'dnxte-divi-essential' ),
					'double-line'   => esc_html__( 'Double Line', 'dnxte-divi-essential' ),
					'strikethrough' => esc_html__( 'Strikethrough', 'dnxte-divi-essential' ),
					'zigzag' 		=> esc_html__( 'Zigzag', 'dnxte-divi-essential' ),
					'wave' 			=> esc_html__( 'Wave', 'dnxte-divi-essential' ),
					'spiral' 		=> esc_html__( 'Spiral', 'dnxte-divi-essential' ),
					'brush' 		=> esc_html__( 'Brush', 'dnxte-divi-essential' ),
					'splash' 		=> esc_html__( 'Splash', 'dnxte-divi-essential' ),
					'brick-wall' 	=> esc_html__( 'Brick Wall', 'dnxte-divi-essential' )
				),				
			),
			// Text Hover Switch
	...
	public function render( $attrs, $content = null, $render_slug ) {
        ...
        $is_highlight_alignment_responsive = et_pb_responsive_options()->is_responsive_enabled($this->props, 'person_alignment');
		...
		if ( "" !== $highlight_text ) {
			$text_highlight = sprintf(
				...
				et_core_esc_previously( $highlight_text )
			);
		}
