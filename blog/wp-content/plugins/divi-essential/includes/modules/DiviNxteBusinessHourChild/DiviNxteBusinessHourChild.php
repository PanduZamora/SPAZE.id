...
class Divi_NxteBusinessHourChild extends ET_Builder_Module
{
    ...
    {
        $this->name = esc_html__('Business Hour Item', 'dnxte-divi-essential');
    ...
    public function get_fields()
    {
        return array(
            'dnxte_businesshour_time' => array(
                ...
                'description' => esc_html__('The time of the day', 'dnxte-divi-essential'),
                'toggle_slug' => 'main_content',
                //'default'         => esc_html__( '9:00 AM - 6:00 PM', 'dnxte-divi-essential' ),
            ...
            'dnxte_businesshour_title' => array(
                ...
                'dynamic_content' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('The day', 'dnxte-divi-essential'),
                'toggle_slug' => 'main_content',
                //'default'        => esc_html__( 'Monday', 'dnxte-divi-essential' ),
