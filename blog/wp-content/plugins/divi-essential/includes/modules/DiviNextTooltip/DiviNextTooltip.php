...
class DiviNextTooltip extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
        ...
        if ("" !== $hotspot_bg) {
            $hotspot_bg_style = sprintf('background-color: %1$s;', esc_attr__($hotspot_bg, 'dnxte-divi-essential'));
            $hotspot_bg_style_tablet = sprintf('background-color: %1$s', esc_attr__($hotspot_bg_tablet, 'dnxte-divi-essential'));
            $hotspot_bg_style_phone = sprintf('background-color: %1$s', esc_attr__($hotspot_bg_phone, 'dnxte-divi-essential'));
        ...
        if ("" !== $hotspot_wave_color) {
            $hotspot_wave_color_style = sprintf('background-color: %1$s;', esc_attr__($hotspot_wave_color, 'dnxte-divi-essential'));
            $hotspot_wave_color_style_tablet = sprintf('background-color: %1$s', esc_attr__($hotspot_wave_color_tablet, 'dnxte-divi-essential'));
            $hotspot_wave_color_style_phone = sprintf('background-color: %1$s', esc_attr__($hotspot_wave_color_phone, 'dnxte-divi-essential'));
            $hotspot_wave_color_style_hover = "";

            if (et_builder_is_hover_enabled('hotspot_wave_color', $this->props)) {
                $hotspot_wave_color_style_hover = sprintf('background-color: %1$s;', esc_attr__($hotspot_wave_color_hover, 'dnxte-divi-essential'));
            }
