...
$inactive_modules    = !empty(self::get_inactive_modules()) ? self::get_inactive_modules() : array();
                            ...
                            <h3 class="dnxte-admin-modules-item-title">
                                ...
                                <?php if ( $demo_url ) : ?>
                                    <a href="<?php echo esc_url( $demo_url ); ?>"
										...
										<img class="dnxte-img-fluid dnxte-item-icon-size" src="<?php echo esc_url( DIVI_ESSENTIAL_ASSETS . 'images/admin/desktop.svg' ); ?>" alt="demo-link">
									</a>
                                <?php endif; ?>
                            </h3>
